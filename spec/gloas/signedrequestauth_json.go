...
// signedRequestAuthJSON is the spec representation of the struct.
...
func (s *SignedRequestAuth) MarshalJSON() ([]byte, error) {
...
func (s *SignedRequestAuth) UnmarshalJSON(input []byte) error {
